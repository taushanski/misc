package com.jpa.many_to_many.service;
...
import com.jpa.many_to_many.entity.SchoolClass;
import com.jpa.many_to_many.entity.Teacher;
...
public class ManyToMany {
	public static void main(String[] args) {
		...
		// Create Clas Entity
		SchoolClass clas1 = new SchoolClass(0, "1st", null);
		SchoolClass clas2 = new SchoolClass(0, "2nd", null);
		SchoolClass clas3 = new SchoolClass(0, "3rd", null);
